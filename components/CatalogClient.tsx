    ...
    <div className="space-y-8">
      ...
      <div className="glass-card p-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="relative w-full md:w-96">
          <Search className="w-5 h-5 absolute left-3.5 top-3.5 text-slate-400 dark:text-zinc-400" />
          <input
            type="text"
            placeholder={t('catalog.searchPlaceholder')}
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            className="w-full bg-slate-100 border border-slate-300 dark:bg-zinc-900 dark:border-zinc-700 rounded-xl pl-11 pr-4 py-2.5 text-sm text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-zinc-400 focus:outline-none focus:border-slate-500 dark:focus:border-zinc-500 transition-colors"
          />
        </div>
        ...
        <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
          ...
          <div className="flex items-center gap-2">
            <ArrowUpDown className="w-4 h-4 text-slate-500 dark:text-zinc-400" />
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value)}
              className="bg-slate-100 border border-slate-300 dark:bg-zinc-900 dark:border-zinc-700 rounded-xl px-3 py-2 text-xs font-semibold text-slate-800 dark:text-zinc-200 focus:outline-none focus:border-slate-500 dark:focus:border-zinc-500"
            >
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-100 border border-slate-300 dark:bg-zinc-900 dark:border-zinc-700 rounded-lg px-2.5 py-1.5 text-xs text-slate-900 dark:text-white"
                  />
                </div>
                <div>
        ...
        <div className="lg:col-span-3">
          {loading ? (
            ...
            <div className="glass-card p-12 text-center space-y-4">
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-white">{t('catalog.noPlansFound')}</h3>
