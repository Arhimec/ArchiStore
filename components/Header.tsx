...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 border-b border-slate-200 dark:bg-zinc-900/90 dark:border-zinc-800 backdrop-blur-md px-4 lg:px-12 py-4 transition-colors duration-300">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-xl bg-slate-900 dark:bg-white flex items-center justify-center text-white dark:text-zinc-950 shadow-md group-hover:scale-105 transition-transform">
          ...
          <div>
            ...
            <span className="block text-[10px] text-slate-500 dark:text-zinc-400 font-mono tracking-wider uppercase -mt-1">
