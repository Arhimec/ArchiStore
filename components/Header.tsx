...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-black/85 backdrop-blur-md border-b border-zinc-800/80 px-4 lg:px-12 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-black shadow-md group-hover:scale-105 transition-transform">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/admin"
            className="hidden sm:flex items-center gap-2 text-xs font-semibold text-zinc-300 hover:text-white bg-zinc-900 border border-zinc-800 px-3.5 py-2 rounded-lg hover:border-zinc-700 transition-all"
          >
