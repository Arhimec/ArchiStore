      ...
      <section className="glass-card-accent p-8 lg:p-14 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          ...
          <h1 className="text-4xl lg:text-6xl font-extrabold text-white tracking-tight leading-tight">
            {t('hero.title1')} <span className="gold-gradient-text">{t('hero.titleHighlight')}</span>
          </h1>
          ...
          <div className="grid grid-cols-3 gap-6 border-t border-slate-800/80 pt-8 mt-8 text-slate-300">
            <div>
              ...
              <span className="text-xs text-slate-400">{t('hero.stat1Text')}</span>
            </div>
            <div>
              <span className="block text-2xl lg:text-3xl font-extrabold text-amber-400">{t('hero.stat2Num')}</span>
              <span className="text-xs text-slate-400">{t('hero.stat2Text')}</span>
            </div>
            <div>
              <span className="block text-2xl lg:text-3xl font-extrabold text-white">{t('hero.stat3Num')}</span>
              <span className="text-xs text-slate-400">{t('hero.stat3Text')}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-8">
        <div className="flex items-end justify-between border-b border-slate-800 pb-4">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">{t('featured.subtitle')}</p>
          </div>
