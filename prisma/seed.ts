...
async function main() {
  ...
  const plan1 = await prisma.plan.create({
    data: {
      ...
      style: 'Farmhouse',
      foundationType: 'Slab',
      ceilingHeight: '9ft First / 9ft Second / 12ft Vaulted Great Room',
      roofPitch: '10:12 Main / 4:12 Porch',
      price: 1250.00,
      isPublished: true,
      featured: true,
  ...
  const plan2 = await prisma.plan.create({
    data: {
      ...
      ceilingHeight: '10ft First / 9ft Second / 18ft Cathedral Great Room',
      roofPitch: '12:12 Timber Gables',
      price: 1850.00,
      isPublished: true,
      featured: true,
  ...
  const plan3 = await prisma.plan.create({
    data: {
      ...
      ceilingHeight: '10ft Flat Monolithic Ceilings',
      roofPitch: '1:12 Low-Slope Metal',
      price: 950.00,
      isPublished: true,
      featured: true,
